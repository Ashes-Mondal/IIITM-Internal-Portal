...
<head>
	...
	<meta name="description" content="SignIn Email Template.">
	<style type="text/css">
		a {
			color: black;
...
<body marginheight="0" topmargin="0" marginwidth="0" style="margin: 0px; background-color: #f2f3f8;" leftmargin="0">
	...
	<table cellspacing="0" border="0" cellpadding="0" width="100%" bgcolor="#f2f3f8"
				...
				<table style="background-color: #f2f3f8; max-width:670px;  margin:0 auto;" width="100%" border="0"
					...
					<tr>
						<td style="text-align:center;display: flex;justify-content: center;align-items: center;">
							<a href="<LINK>" title="logo" target="_blank">
								<svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
									xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="60px"
									height="60px" viewBox="0 0 878.863 878.863"
									style="enable-background:new 0 0 878.863 878.863;" xml:space="preserve">
									<g>
		...
		C207.836,292.3,202.237,297.2,196.737,302.2z" />
							...
							<a href="<LINK>" title="logo" target="_blank">IIITM</a>
						</td>
					</tr>
					<tr>
								...
								<tr>
									<td style="padding:0 35px;">
										<h1
											...
											SignIn as <strong>{EMAIL}</strong>
										</h1>
										<span
											style="display:inline-block; vertical-align:middle; margin:29px 0 26px; border-bottom:1px solid #cecece; width:100px;"></span>
										<p style="color:#455056; font-size:15px;line-height:24px; margin:0;">
											Welcome abroad,you can start contributing once you are logged in and
											verified.
										</p>
										<p>
											To preceed forward click the below link.
										</p>
										<a href="{URL}"
											style="background:#9b68c5;text-decoration:none !important; font-weight:500; margin-top:35px; color:#fff;text-transform:uppercase; font-size:14px;padding:10px 24px;display:inline-block;border-radius:50px;">
											LogIn
										</a>
										<p>
...
`
export function html({ url, host, email }: Record<"url" | "host" | "email", string>) {
